        ...
        <div class="header-content" id="login">
            <div class="header-content-inner">
                ...
                <div id="home_user_box">
                    ...
                    <div id="home_projects_to_help">Projects to Help</div>
                    <div id="home_my_projects">My Projects</div>
                    <div id="home_add_project">Add Project</div>
                </div>
                <?php }else{ ?>
                    <a href="facebook/fbconfig.php"><div id="facebook_btn"></div></a></div>
                <? } ?>
            </div>
        </div>
    </header>
